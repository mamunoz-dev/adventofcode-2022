...
function part2perf(input, size = 4000000) {
...
console.log(part1(sample, 10)); // 26
console.log(part1(input, 2000000)); // 4886370
console.log(part2(sample, 20)); // 56000011
console.log(part2perf(input, 4000000)); // 11374534948438
